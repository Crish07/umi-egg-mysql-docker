...
import findRoute, {
  getUrlQuery,
} from '/Users/crish/.nvm/versions/node/v10.19.0/lib/node_modules/umi/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../../../../../../.nvm/versions/node/v10.19.0/lib/node_modules/umi/node_modules/umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path:
          '/Users/crish/Downloads/web-study/test-space/umi-egg-mysql-docker/umi-antd-dva',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../../../../../../.nvm/versions/node/v10.19.0/lib/node_modules/umi/node_modules/umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
